...
var myTruck = new Truck('Ford', 'Truck', 2009, 'White', 3, 8);
assert.strictEqual(myTruck.make, 'Ford', 'Constructor did not set make.');
assert.strictEqual(myTruck.model, 'Truck', 'Constructor did not set model.');
assert.strictEqual(myTruck.year, 2009, 'Constructor did not set year.');
assert.strictEqual(myTruck.color, 'White', 'Constructor did not set color.');
assert.strictEqual(myTruck.seats, 3, 'Constructor did not set seats.');
assert.strictEqual(myTruck.wheels, 8, 'Constructor did not set seats.');
success();
